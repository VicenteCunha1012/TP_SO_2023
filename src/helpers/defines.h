...
#define JOGOUI_EXIT_SUCCESS 0
#define JOGOUI_COMMAND_NOT_FOUND 1
#define JOGOUI_SELF_NAME 2
#define JOGOUI_PLAYERS_SUCCESS 3
#define JOGOUI_WRONG_ARGS 4
#define JOGOUI_MSG_SUCCESS 5

#define MOTOR_COMMAND_NOT_FOUND 1
#define MOTOR_END_SUCCESS 2
#define MOTOR_BEGIN_SUCCESS 3
#define MOTOR_USERS_SUCCESS 4
#define MOTOR_WRONG_ARGS 5
